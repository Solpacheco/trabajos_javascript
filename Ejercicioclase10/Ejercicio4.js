...
// Declaración de variables según su tipo de dato
let verdadero = true;
let texto = "Estoy aprendiendo a programar";
let numero = 10;
let nada = null;
...
let textoCompleto = texto + " y me está gustando mucho.";
...
// Validación de null
if (nada === null) {
  console.log("La variable nada no tiene ningún valor");
}
